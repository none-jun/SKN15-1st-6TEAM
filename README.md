...
### 데이터 수집 및 크롤링 담당 (이준원)
2023년 1월부터 2025년 4월까지의 국내 자동차 판매 및 등록 관련 데이터를 다양한 웹사이트와 공개 API를 통해 자동화 크롤링 및 수집

Python 기반 크롤러 개발 (BeautifulSoup, Selenium 등 활용)

수집한 데이터를 분석에 적합하도록 전처리 및 정제하여 데이터 품질 확보

프로젝트 분석의 기초가 되는 신뢰성 높은 데이터셋 구축
---
