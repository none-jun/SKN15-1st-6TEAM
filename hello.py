...
img_base64_1 = get_base64_image("E:/SK네트웍스 Family AI 캠프/1차 단위 프로젝트/image 3.png")
img_base64_2 = get_base64_image("E:/SK네트웍스 Family AI 캠프/1차 단위 프로젝트/image 4.png") # 나중에 등록 현황 이미지 넣을 경우
